document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('click', function (e) {
    ...
    const navEl = document.querySelector('nav, header, .navbar, [role="navigation"]');
  ...
  if (contactForm) {
    ...
    function getErrorMessage(field, rule) {
      const label = field.closest('[class*="field"], [class*="group"], [class*="wrap"], label, div')
        ? (field.closest('label') || document.querySelector('label[for="' + field.id + '"]'))
        : null;
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      const successMsg = contactForm.querySelector('.form-success') || (function () {
      ...
      setTimeout(function () {
        ...
        contactForm.querySelectorAll('.input-valid').forEach(function (f) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'df98af2e-8bbb-4754-9c66-cd75d76837d1',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'df98af2e-8bbb-4754-9c66-cd75d76837d1';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'df98af2e-8bbb-4754-9c66-cd75d76837d1';
